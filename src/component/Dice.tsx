...
const D20 = ({ n, size }) => {
    ...
    return (
        <div
            style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: size, height: size, }}
        >
            <svg viewBox="0 0 172 172" fill="none" data-dietype="20" xmlns="http://www.w3.org/2000/svg"><g transform="translate(0, 172) scale(1, -1)"><path d="M86 34.4004L139.75 129H32.25L86 34.4004Z" fill="#D899BF"></path><path d="M86 0L172 34.4H0L86 0Z" fill="#C466A4"></path><path d="M86 172L139.75 129H32.25L86 172Z" fill="#9D0068"></path><path d="M86 34.4004L139.75 129L172 34.4004H86Z" fill="#B33581"></path><path d="M86 34.4004L32.25 129L0 34.4004H86Z" fill="#B33581"></path><path d="M139.75 129L172 34.4V129H139.75Z" fill="#870051"></path><path d="M32.25 129L0 34.4V129H32.25Z" fill="#870051"></path><path d="M172 129L86 172L139.75 129H172Z" fill="#6B0040"></path><path d="M-3.8147e-06 129L86 172L32.25 129H-3.8147e-06Z" fill="#6B0040"></path></g><text x="50%" y="87px" fill="#111111" font-size="70px" font-weight="400" alignment-baseline="middle" text-anchor="middle">{n || ""}</text></svg>
        </div>
    )
}
...
export const CustomDice = ({ id, value = 0, type = 6, size = 50, style = {}, isSelected = false, onClick }: { id: string; value?: number; type?: number; size?: number; style?: React.CSSProperties; isSelected?: boolean; onClick: () => void }) => {
    ...
    if (type === 8 || type === 12 || type === 10 || type === 20) {
        return (
            <div
            ...
            >
                ...
                {type === 20 && <D20 n={value} size={size} />}
                <div className="dice-label">D{type}</div>
            </div>
        );
    }
